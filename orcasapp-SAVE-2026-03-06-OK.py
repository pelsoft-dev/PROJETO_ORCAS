...
st.markdown("""
    ...
    /* Fixar o Header no topo com reforço de profundidade (z-index) */
    .fixed-header {
        position: fixed;
        top: 0;
        left: 0;
    ...
    /* Ajuste para o título ORCAS não quebrar */
    .logo-container {
        white-space: nowrap;
        font-weight: bold;
        font-size: 1.8rem;
    ...
    /* Ajuste para o rótulo do Saldo Inicial não ser sobreposto */
    .saldo-label {
        font-size: 0.8rem;
        color: #555;
        margin-bottom: 2px;
...
# Aumentei levemente a proporção da primeira e segunda coluna para caber o texto
...
with c2:
    # Adicionado um pequeno rótulo acima para evitar sobreposição interna do Streamlit
